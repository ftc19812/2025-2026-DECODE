package org.firstinspires.ftc.teamcode.teamfiles.Team2.RRFiles.tuning;
...
import org.firstinspires.ftc.teamcode.teamfiles.Team2.RRFiles.drivelocalizers.OTOSLocalizer;
import org.firstinspires.ftc.teamcode.teamfiles.Team2.RRFiles.drivelocalizers.TankDrive;
import org.firstinspires.ftc.teamcode.teamfiles.Team2.RRFiles.drivelocalizers.Team2MecanumDrive;
import org.firstinspires.ftc.teamcode.teamfiles.Team2.RRFiles.drivelocalizers.Team2PinpointLocalizer;
import org.firstinspires.ftc.teamcode.teamfiles.Team2.RRFiles.drivelocalizers.ThreeDeadWheelLocalizer;
import org.firstinspires.ftc.teamcode.teamfiles.Team2.RRFiles.drivelocalizers.TwoDeadWheelLocalizer;
...
public final class TuningOpModes {
    ...
    public static final Class<?> DRIVE_CLASS = Team2MecanumDrive.class;
    ...
    private static PinpointView makePinpointView(Team2PinpointLocalizer pl) {
    ...
    public static void register(OpModeManager manager) {
        ...
        if (DRIVE_CLASS.equals(Team2MecanumDrive.class)) {
            dvf = hardwareMap -> {
                Team2MecanumDrive md = new Team2MecanumDrive(hardwareMap, new Pose2d(0, 0, 0));
                ...
                if (md.localizer instanceof Team2MecanumDrive.DriveLocalizer) {
                    Team2MecanumDrive.DriveLocalizer dl = (Team2MecanumDrive.DriveLocalizer) md.localizer;
                ...
                }  else if (md.localizer instanceof Team2PinpointLocalizer) {
                    PinpointView pv = makePinpointView((Team2PinpointLocalizer) md.localizer);
                ...
                return new DriveView(
                    DriveType.MECANUM,
                        Team2MecanumDrive.PARAMS.inPerTick,
                        Team2MecanumDrive.PARAMS.maxWheelVel,
                        Team2MecanumDrive.PARAMS.minProfileAccel,
                        Team2MecanumDrive.PARAMS.maxProfileAccel,
                        encoderGroups,
                        Arrays.asList(
                                md.leftFront,
                                md.leftBack
                        ...
                        lazyImu,
                        md.voltageSensor,
                        () -> new MotorFeedforward(Team2MecanumDrive.PARAMS.kS,
                                Team2MecanumDrive.PARAMS.kV / Team2MecanumDrive.PARAMS.inPerTick,
                                Team2MecanumDrive.PARAMS.kA / Team2MecanumDrive.PARAMS.inPerTick),
                        0
                );
            };
            ...
            dvf = hardwareMap -> {
                ...
                if (td.localizer instanceof TankDrive.DriveLocalizer) {
                    ...
                    parEncs.add(new EncoderRef(0, 0));
                    perpEncs.add(new EncoderRef(0, 1));
                }  else if (td.localizer instanceof Team2PinpointLocalizer) {
                    PinpointView pv = makePinpointView((Team2PinpointLocalizer) td.localizer);
                    encoderGroups.add(new PinpointEncoderGroup(pv));
                    parEncs.add(new EncoderRef(0, 0));
                    perpEncs.add(new EncoderRef(0, 1));
                    lazyImu = new PinpointIMU(pv);
