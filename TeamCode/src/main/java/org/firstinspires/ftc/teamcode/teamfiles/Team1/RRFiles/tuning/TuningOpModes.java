package org.firstinspires.ftc.teamcode.teamfiles.Team1.RRFiles.tuning;
...
import org.firstinspires.ftc.teamcode.teamfiles.Team1.RRFiles.drivelocalizers.OTOSLocalizer;
import org.firstinspires.ftc.teamcode.teamfiles.Team1.RRFiles.drivelocalizers.TankDrive;
import org.firstinspires.ftc.teamcode.teamfiles.Team1.RRFiles.drivelocalizers.Team1MecanumDrive;
import org.firstinspires.ftc.teamcode.teamfiles.Team1.RRFiles.drivelocalizers.Team1PinpointLocalizer;
import org.firstinspires.ftc.teamcode.teamfiles.Team1.RRFiles.drivelocalizers.ThreeDeadWheelLocalizer;
import org.firstinspires.ftc.teamcode.teamfiles.Team1.RRFiles.drivelocalizers.TwoDeadWheelLocalizer;
...
public final class TuningOpModes {
    ...
    public static final Class<?> DRIVE_CLASS = Team1MecanumDrive.class;
    ...
    private static PinpointView makePinpointView(Team1PinpointLocalizer pl) {
    ...
    public static void register(OpModeManager manager) {
        ...
        if (DRIVE_CLASS.equals(Team1MecanumDrive.class)) {
            dvf = hardwareMap -> {
                Team1MecanumDrive md = new Team1MecanumDrive(hardwareMap, new Pose2d(0, 0, 0));
                ...
                if (md.localizer instanceof Team1MecanumDrive.DriveLocalizer) {
                    Team1MecanumDrive.DriveLocalizer dl = (Team1MecanumDrive.DriveLocalizer) md.localizer;
                ...
                }  else if (md.localizer instanceof Team1PinpointLocalizer) {
                    PinpointView pv = makePinpointView((Team1PinpointLocalizer) md.localizer);
                ...
                return new DriveView(
                    DriveType.MECANUM,
                        Team1MecanumDrive.PARAMS.inPerTick,
                        Team1MecanumDrive.PARAMS.maxWheelVel,
                        Team1MecanumDrive.PARAMS.minProfileAccel,
                        Team1MecanumDrive.PARAMS.maxProfileAccel,
                        encoderGroups,
                        Arrays.asList(
                                md.leftFront,
                                md.leftBack
                        ...
                        lazyImu,
                        md.voltageSensor,
                        () -> new MotorFeedforward(Team1MecanumDrive.PARAMS.kS,
                                Team1MecanumDrive.PARAMS.kV / Team1MecanumDrive.PARAMS.inPerTick,
                                Team1MecanumDrive.PARAMS.kA / Team1MecanumDrive.PARAMS.inPerTick),
                        0
                );
            };
            ...
            dvf = hardwareMap -> {
                ...
                if (td.localizer instanceof TankDrive.DriveLocalizer) {
                    ...
                    parEncs.add(new EncoderRef(0, 0));
                    perpEncs.add(new EncoderRef(0, 1));
                }  else if (td.localizer instanceof Team1PinpointLocalizer) {
                    PinpointView pv = makePinpointView((Team1PinpointLocalizer) td.localizer);
                    encoderGroups.add(new PinpointEncoderGroup(pv));
                    parEncs.add(new EncoderRef(0, 0));
                    perpEncs.add(new EncoderRef(0, 1));
                    lazyImu = new PinpointIMU(pv);
